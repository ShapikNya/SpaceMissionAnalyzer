...
namespace SpaceMissions
{
    ...
    public class Person
    {
        ...
        public Person(int id, string name)
        {
            ...
            if (name is null || string.Equals(name,"")) throw new ArgumentException("name must be not null!");
    ...
    public class Spaceship
    {
        ...
        {
            if (id < 0) throw new ArgumentException("id must be positive!");
            if (model is null || string.Equals(model, "")) throw new ArgumentException("model must be not null!");
    ...
    public class Item
    {
        ...
        public Item(int id, string name, double weight, double price=0)
        {
            if (id < 0) throw new ArgumentException("id must be positive!");
            if (name is null || string.Equals(name, "")) throw new ArgumentException("name must be not null!");
            ...
            _id = id; _name = name; _weight = weight; _price = price;
        }
    }
    ...
    public class PrepareMission
    {
        ...
        {
            if (id < 0) throw new ArgumentException("Id must be positive!", nameof(id));
            if (name == null || string.Equals(name, "")) throw new ArgumentException(nameof(name), "Name must not be null!");
